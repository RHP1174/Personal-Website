...
const introdata = {
    ...
    description: "Hello, I am a recent graduate from the University of Washington with a Bachelor's " +
...
const contactConfig = {
    ...
    YOUR_SERVICE_ID: "service_vnoce3n",
    YOUR_TEMPLATE_ID: "template_e2fvfzs",
